...
public class JwtTokenProvider {
    ...
    private static final long ACCESS_TOKEN_EXPIRED_DURATION = DAY; // Access token 만료시간 : 하루
     ...
     */
    public JwtTokenInfoDto createAccessToken(Long userId, LoginType loginType) {
        return createJwtToken(userId, RoleType.USER, loginType, ACCESS_TOKEN_EXPIRED_DURATION);
    }
     ...
     * @return 생성한 jwt token
     */
    public JwtTokenInfoDto createRefreshToken(Long userId, LoginType loginType) {
        return createJwtToken(userId, RoleType.USER, loginType, REFRESH_TOKEN_EXPIRED_DURATION);
    }
     ...
     */
    private JwtTokenInfoDto createJwtToken(Long userId, RoleType roleType, LoginType loginType, Long tokenExpiredDuration) {
        Date now = new Date();
